...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative w-full bg-[#0a0a1a] border-t border-gray-800 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="flex items-center gap-4">
            {socialIcons.map((social, index) => (
              <a
                key={index}
                href="#"
                className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-purple-500 transition-colors"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-gray-800">
          <div className="flex items-center gap-2">
            <BeatifyLogo size="sm" showText={true} textColor="light" />
          </div>
          <p className="text-gray-400 text-sm" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
            © {new Date().getFullYear()} Beatify. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
